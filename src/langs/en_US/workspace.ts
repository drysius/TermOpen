...
export const workspace: AppDictionary["workspace"] = {
  ...
  remoteRdp: "Remote RDP",
  sourceLabel: "Connection",
  sourceHelpTerminal: "Choose an SSH connection to open a remote terminal.",
  sourceHelpFiles: "Choose a remote connection to open files (SFTP/FTP/FTPS/SMB).",
  sourceHelpRdp: "Choose an RDP connection to open remote desktop.",
