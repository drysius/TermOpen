...
import type { ConnectionProfile, RdpCaptureResult, SftpEntry } from "@/types/termopen";
...
type WorkspaceBlock = TerminalBlock | SftpBlock | RdpBlock | EditorBlock | LogsBlock;
    ...
    async (
      ...
      try {
        ...
        if (timeoutDetected) {
          ...
          const canRetry = settings.auto_reconnect_enabled && nextAttempt <= MAX_CONNECT_RETRY_ATTEMPTS;
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-zinc-950">
      ...
      <div className="relative min-h-0 flex-1 overflow-hidden p-2">
        <div className="relative h-full overflow-hidden rounded border border-white/10 bg-zinc-950">
          {block.imageBase64 ? (
            <img
